...
print(gibbs_p5_diag_inst1_part1.get_sample_mean())
print(gibbs_p5_diag_inst1_part1.get_sample_var())
print(gibbs_p5_diag_inst1_part1.get_sample_quantile([0.025, 0.975]))
...
print(gibbs_p5_diag_inst1_part2.get_sample_mean())
print(gibbs_p5_diag_inst1_part2.get_sample_var())
print(gibbs_p5_diag_inst1_part2.get_sample_quantile([0.025, 0.975]))
...
print(gibbs_p5_diag_inst1_part3.get_sample_mean())
print(gibbs_p5_diag_inst1_part3.get_sample_var())
print(gibbs_p5_diag_inst1_part3.get_sample_quantile([0.025, 0.975]))
